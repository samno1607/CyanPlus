...
static struct omap_volt_data omap44xx_vdd_mpu_volt_data[] = {
	...
	{.volt_nominal = 1025000, .sr_errminlimit = 0xF9, .vp_errgain = 0x16, .abb_type = NOMINAL_OPP},
	{.volt_nominal = 1075000, .sr_errminlimit = 0xF9, .vp_errgain = 0x16, .abb_type = NOMINAL_OPP},
	{.volt_nominal = 1100000, .sr_errminlimit = 0xF9, .vp_errgain = 0x16, .abb_type = NOMINAL_OPP},
	{.volt_nominal = 1150000, .sr_errminlimit = 0xFA, .vp_errgain = 0x23, .abb_type = NOMINAL_OPP},
	{.volt_nominal = 1175000, .sr_errminlimit = 0xFA, .vp_errgain = 0x23, .abb_type = NOMINAL_OPP},
	{.volt_nominal = 1200000, .sr_errminlimit = 0xFA, .vp_errgain = 0x27, .abb_type = FAST_OPP},
	{.volt_nominal = 1250000, .sr_errminlimit = 0xFA, .vp_errgain = 0x27, .abb_type = FAST_OPP},
...
static struct omap_vdd_dep_volt omap44xx_vddmpu_vddcore_data[] = {
	{.main_vdd_volt = 850000, .dep_vdd_volt = 1025000},
	{.main_vdd_volt = 900000, .dep_vdd_volt = 1025000},
	{.main_vdd_volt = 925000, .dep_vdd_volt = 1025000},
	{.main_vdd_volt = 1000000, .dep_vdd_volt = 1200000},
	{.main_vdd_volt = 1025000, .dep_vdd_volt = 1200000},
	{.main_vdd_volt = 1075000, .dep_vdd_volt = 1200000},
	{.main_vdd_volt = 1100000, .dep_vdd_volt = 1200000},
	{.main_vdd_volt = 1150000, .dep_vdd_volt = 1200000},
	{.main_vdd_volt = 1175000, .dep_vdd_volt = 1200000},
	{.main_vdd_volt = 1200000, .dep_vdd_volt = 1200000},
	{.main_vdd_volt = 1250000, .dep_vdd_volt = 1200000},
